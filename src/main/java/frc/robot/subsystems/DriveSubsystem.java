...
public class DriveSubsystem{
    ...
    private double rightTareEncoder = 0.0;

    public final double MAXVOLTAGE = 0.9;
    public final double ADJFALCONS = 0.000;
    ...
    public double countsToInches(double ticks){ 
      ...
      //System.out.println("Inches: " + inches); //FOR TESTING
      return inches;
    } 
    ...
    public void resetEncoders(){
        ...
        rightTareEncoder = RB.getSelectedSensorPosition();
    ...
    public double getRightTicks(){
        return RB.getSelectedSensorPosition() - rightTareEncoder;
    }
